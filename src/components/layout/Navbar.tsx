    ...
    <nav className="navbar">
      <div className="nav-inner">
        ...
        <div className="nav-links">
          <Link to="/" className={pathname === '/' ? 'active' : ''}>{t('nav_browser')}</Link>
          <Link to="/editor" className={pathname === '/editor' ? 'active' : ''}>{t('nav_editor')}</Link>
          <Link to="/how-to" className={pathname === '/how-to' ? 'active' : ''}>{t('nav_howto')}</Link>
          <a href="../mqtt-cli/">{t('nav_mqtt')}</a>
        </div>
        <a
          href="https://discord.com/invite/HfJVk9J29K"
          target="_blank"
          rel="noopener noreferrer"
          className="discord-btn"
          title="Join Cornmeister.nl Discord"
          aria-label="Join Cornmeister.nl Discord"
        >
